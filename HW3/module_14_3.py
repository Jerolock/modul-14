...
API = 'XXX'
PRODUCTS = [
    ['Лот #001', 'Очень бюджетный вариант', 199, 'image/006.jfif'],
    ['Лот #002', 'Разновидность бюджетного варианта', 299, 'image/003.jfif'],
    ['Лот #003', 'Инструкция для самостоятельной реализации на базе экранов Nextion', 2_999, 'image/009.jfif'],
    ['Лот #004', 'Высокоинтеллектуальное решение на базе ИИ', 29_999, 'image/007.jfif'],
    ['Лот #005', 'Высокоинтеллектуальное решение на базе ИИ с дактилоскопическим анализом состояния здоровья',
     69_999, 'image/008.jfif'],
    ['Лот #006', 'Самое эффективное решение по невероятно низкой цене', 9, 'image/010.jfif']
]
bot = Bot(token=API)
